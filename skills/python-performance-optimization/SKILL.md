...
- **Consider NumPy for numerical operations**: Native speed for math
- **Profile production code**: Use py-spy for live systems

## Common Pitfalls

- **Optimizing without profiling**: Guessing is not science
- **Using global variables unnecessarily**: Slower access
- **Not using appropriate data structures**: Lists for lookups
- **Creating unnecessary copies of data**: Memory waste
- **Not using connection pooling for databases**: Connection overhead
- **Ignoring algorithmic complexity**: O(n^2) vs O(n)
- **Over-optimizing rare code paths**: Waste of effort
- **Not considering memory usage**: OOM crashes
